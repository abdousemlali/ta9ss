package com.example.ta9ss;

import static com.example.ta9ss.location.CityFinder.getCityNameUsingNetwork;
import static com.example.ta9ss.location.CityFinder.setLongitudeLatitude;
import static com.example.ta9ss.network.InternetConnectivity.isInternetConnected;
...
import com.example.ta9ss.adapter.DaysAdapter;
import com.example.ta9ss.databinding.ActivityHomeBinding;
import com.example.ta9ss.location.LocationCord;
import com.example.ta9ss.toast.Toaster;
import com.example.ta9ss.update.UpdateUI;
import com.example.ta9ss.url.URL;
